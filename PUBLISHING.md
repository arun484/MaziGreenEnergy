...
4.  **Add Environment Variables:**
    ...
    *   Click **Add Environment Variable** to add the other secrets:
        ...
        *   `CLIENT_URL`: The URL of your deployed Netlify site. **CRITICAL:** This must be the exact origin, with no trailing slash (e.g., `https://warm-griffin-19aa15.netlify.app`).
